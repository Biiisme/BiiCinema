                    ...
                    <div class="form-container">
                        <form class="form-horizontal" action="AddMovieController" method="post" enctype= "multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="movieTitle" name="TenPhim" value="<%=mv.getTenPhim() %>" required>
                            </div>
                            <div class="mb-3">
                                <label for="movieDescription" class="form-label">Mô tả ngắn</label>
                                <textarea class="form-control" id="movieDescription" name="MoTaNgan" rows="2" required><%=mv.getMoTaNgan()%></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="movieDescription" class="form-label">Mô tả dài</label>
                              	 <textarea class="form-control" id="movieDescription" name="MoTaDai" rows="3" required><%=mv.getMoTaDai()%></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="movieGenre" class="form-label">Thể loại</label>
                                <input type="text" class="form-control" id="movieGenre" name="TheLoai" value="<%=mv.getLoai() %>" required>
                            </div>
                            <div class="mb-3">
                                <label for="movieGenre" class="form-label">Đạo diễn</label>
                                <input type="text" class="form-control" id="movieGenre" name="DaoDien" value="<%=mv.getDaoDien() %>" required>
                            </div>
                            <div class="mb-3">
                                <label for="movieGenre" class="form-label">Diễn viên</label>
                                <input type="text" class="form-control" id="movieGenre" name="DienVien" value="<%=mv.getDienVien()%>" required>
                            </div>
                            <div class="mb-3">
                                <label for="movieGenre" class="form-label">Đối tượng</label>
                                <input type="text" class="form-control" id="movieGenre" name="DoiTuong" value="<%=mv.getDoiTuong() %>" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="movieReleaseDate" name="NgayPhatHanh" value="<%=mv.getNgayKhoiChieu() %>" required>
                            </div>
                            <div class="mb-3">
                                <label for="moviePoster" class="form-label">Poster phim</label>
                                <input type="file" class="form-control" id="moviePoster" name="Poster" accept="<%=mv.getPoster_url() %>" value="<%=mv.getPoster_url() %>" required>
                                <br>
                                <img src="<%= mv.getPoster_url() != null ? mv.getPoster_url() : "https://via.placeholder.com/150" %>"
                            	 class="img-thumbnail" alt="Ảnh sách" style="max-width: 150px;">
                            </div>
                            <div class="mb-3">
                                <label for="movieTrailer" class="form-label">Link trailer</label>
                                <input type="url" class="form-control" id="movieTrailer" name="LinkTrailer" value="<%=mv.getTrailer_url() %>" required>
                            </div>
