...
<head>
    ...
    <style>
        ...
        .btnn{background-color: #ff8d1e; color:#fff;}
        .btnn:hover, .btnn:focus, .btnn.active {background: #4b92dc;color: #fff;
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="widget no-box">
                        <h5 class="widget-title">Support Me<span></span></h5>
                        <p>Subscribe For My Youtube Channel</p>
                        <a class="btnn" href="https://www.youtube.com/@thangphan4248" target="_blank">Subscribe Now</a>
                    </div>
                </div>
